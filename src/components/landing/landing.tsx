...
export default function BatikuHomepage() {
  ...
  const patterns = [
    { name: "", from: "#78350f", to: "#b45309" },
    { name: "", from: "#1e3a8a", to: "#1d4ed8" },
    { name: "", from: "#312e81", to: "#4338ca" },
    { name: "", from: "#134e4a", to: "#0f766e" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 via-white to-zinc-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl border-b border-zinc-200 dark:border-zinc-800 z-50">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-100 dark:bg-amber-950 rounded-full text-amber-800 dark:text-amber-200 text-sm font-medium">
                <Star className="w-4 h-4 fill-current" />
                Powered by Amazon Bedrock AI
              </div>

              <h1 className="text-6xl lg:text-7xl font-bold text-zinc-900 dark:text-zinc-50 leading-tight">
                Ciptakan
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  href="#features"
                  className="px-8 py-4 border-2 border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100 rounded-full hover:border-amber-600 dark:hover:border-amber-600 hover:text-amber-600 transition-all duration-200 font-semibold"
                >
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-amber-200 to-amber-300 dark:from-amber-900/30 dark:to-amber-800/30 rounded-3xl blur-3xl opacity-30"></div>
              <div className="relative grid grid-cols-2 gap-4">
                {patterns.map((pattern, i) => (
                  <div
                    key={i}
                    className="aspect-square rounded-2xl hover:scale-105 transition-transform duration-300 cursor-pointer shadow-lg hover:shadow-2xl overflow-hidden"
                    style={{
                      background: `linear-gradient(135deg, ${pattern.from}, ${pattern.to})`,
                    }}
                  >
                    <div className="h-full flex items-end p-4 bg-gradient-to-t from-black/30 to-transparent">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, i) => (
              <div
                ...
                className="group p-8 rounded-2xl border-2 border-zinc-200 dark:border-zinc-800 hover:border-amber-600 dark:hover:border-amber-600 transition-all duration-300 hover:shadow-xl cursor-pointer"
              >
                <div
                  className={`w-14 h-14 rounded-xl bg-gradient-to-br from-amber-600 to-amber-700 flex items-center justify-center mb-6 transform transition-transform duration-300 ${
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center space-y-4">
                <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-amber-600 to-amber-700 flex items-center justify-center text-white font-bold text-xl">
                  {item.step}
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                key={i}
                className="p-6 rounded-xl border-2 border-zinc-200 dark:border-zinc-800 hover:border-amber-600 dark:hover:border-amber-600 transition-colors"
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {item.features.map((feature, j) => (
                    <div
                      key={j}
                      className="flex items-center gap-2 px-3 py-1 bg-zinc-100 dark:bg-zinc-800 rounded-full text-sm text-zinc-700 dark:text-zinc-300"
                    >
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-12 rounded-3xl bg-gradient-to-br from-amber-600 to-amber-800 text-white relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              <a
                ...
                target="_blank"
                className="text-zinc-600 dark:text-zinc-400 hover:text-amber-600 transition-colors"
              >
                GitHub
              </a>
            </div>
